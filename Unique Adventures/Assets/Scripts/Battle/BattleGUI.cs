...
public class BattleGUI : MonoBehaviour
{
    ...
    public void Init(List<PlayerChampion> playersArg)
    {
        ...
        battleMessage = gameObject.transform.GetChild(0).GetComponent<TextMeshPro>();
    ...
    {
        GameObject newButtonObject = Instantiate(PrefabManager._prefabs.actionButtonPrefab, position, Quaternion.identity);
